...
import TouchableOpacityWithoutMultiplePress from '../../TouchableOpacityWithoutMultiplePress'
...
export default class extends Component {
  ...
  static propTypes = {
    ...
    useCustomNextButton: PropTypes.bool,
    onCustomNextButtonPressed: PropTypes.func,
  }
  ...
  static defaultProps = {
    ...
    index: 0,
    onIndexChanged: () => null,
    useCustomNextButton: false,
    onCustomNextButtonPressed: () => null,
  }
  ...
  onNextButtonPressed(button) {
    if (this.props.useCustomNextButton) {
      this.props.onCustomNextButtonPressed();
    }
    else {
  ...
  setPreviousButtonOpacity() {
    if (Platform.OS === 'ios' && this.state.index === 1) {
      return 0.8;
    }
    return 0.2;
  }
  ...
  renderNextButton = () => {
    ...
    if (this.props.loop || this.props.useCustomNextButton ||
      this.state.index !== this.state.total - 1) {
      button = this.props.nextButton || <Text style={styles.buttonText}>›</Text>
    }

    return (
      <TouchableOpacityWithoutMultiplePress
        delay={200}
        onPress={() => {
          this.onNextButtonPressed(button);
        }}
  ...
  renderPrevButton = () => {
    ...
    return (
      <TouchableOpacityWithoutMultiplePress
        delay={200}
        onPress={() => {
          this.props.onPrevButtonPressed();
          return button !== null && this.scrollBy(-1)}
        }
        activeOpacity={this.setPreviousButtonOpacity()}
      >
        <View>
          {button}
        </View>
